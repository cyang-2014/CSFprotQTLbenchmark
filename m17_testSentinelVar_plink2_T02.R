...
covarFILE<- paste0(covardir, 'f02b_EURgeno_covar_2249pariticipants.txt')


outdir <- '/03-DryLab/04-Analyses/2021_Multi-Omics_CC/2022_MultiTissue-MultiOmics_Chengran/t16_benchmarkQTL/run01_CSFlongsLOG10z/d02_plink2OUTnoPEER/t02_sentinelVars/output/'
list.files(outdir)
...
for(i in 1:nrow(unionSets.dt.uniqID.protFound)) {
  ...
  cmd_plink2 <- paste0('/home/yangc/myprogram/plink2_20230607 --bfile ', filename,
                       ...
                       ' --out ', outdir, 'T02_CSFplink2_sentinelVar', 
...
#   plink2sentOUT <- fread(paste0(outdir, 'T02_CSFplink2_sentinelVar',
#                                 unionSets.dt.uniqID.protFound$protVarBlockID[i], '.',
