...
outdir <- '/03-DryLab/04-Analyses/2021_Multi-Omics_CC/2022_MultiTissue-MultiOmics_Chengran/t16_benchmarkQTL/run02_CSFlongsINVR/d05_plink2OUTwiPEER/t02_sentinelVars/output/'
list.files(outdir)
...
for(i in 1:nrow(unionSets.dt.uniqID.protFound)) {
  ...
  cmd_plink2 <- paste0('/home/yangc/myprogram/plink2_20230607 --bfile ', filename,
                       ...
                       ' --out ', outdir, 'T05_CSFplink2_sentinelVar', 
...
#   plink2sentOUT <- fread(paste0(outdir, 'T05_CSFplink2_sentinelVar',
#                                 unionSets.dt.uniqID.protFound$protVarBlockID[i], '.',
